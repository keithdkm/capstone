...
freqtable<-data.table(ngram = blog.tdm$dimnames$Terms[blog.tdm$i], Length = stri_count_words(blog.tdm$dimnames$Terms[blog.tdm$i]), Document = blog.tdm$j, Frequency = blog.tdm$v)
