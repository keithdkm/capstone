...
- Use a hashing function for fast searching of Ngrams - doesn't seem to be necessary if using data tables
- Use RDS files for rapid file writing and reading - done
